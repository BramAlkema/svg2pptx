...
from core.config.hybrid_config import HybridConversionConfig, ConversionMode
from core.converters.base import ConverterRegistryFactory, ConversionContext
...
class TestHybridModeIntegration:
    ...
    def test_ir_bridge_creation_with_missing_services(self):
        ...
        from core.converters.ir_bridge import IRConverterBridge
