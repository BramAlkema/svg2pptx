...
class MeshGradientEngine:
    ...
    def convert_mesh_gradient(self, element: ET.Element) -> str:
        ...
        try:
            ...
            if not mesh_patches:
                ...
                return f'<a:solidFill xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"><a:srgbClr val="{fallback_color}"/></a:solidFill>'
    ...
    def _convert_4_corner_mesh_to_radial(self, mesh_patch: MeshPatch) -> str:
        ...
        return f'''<a:gradFill xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" flip="none" rotWithShape="1">
            <a:gsLst>
