...
class SVGParser:
    ...
    def _convert_rect_to_ir(self, element: ET.Element):
        ...
        from ..ir import Path, Point, LineSegment
    ...
    def _extract_styling(self, element: ET.Element):
        ...
        from ..ir import SolidPaint, Stroke, StrokeJoin, StrokeCap
    ...
    def _extract_text_lines(self, element: ET.Element) -> List:
        ...
        """
        from ..ir import TextLine, TextAnchor
    ...
    def _parse_path_data(self, d: str):
        ...
        from ..ir import Point, LineSegment, BezierSegment
