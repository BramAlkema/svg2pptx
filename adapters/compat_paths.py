...
class A2CAdapter:
    ...
    Wraps core/paths/a2c.py functionality to convert SVG arcs to Bezier curves.
    ...
    def convert_arc_to_cubic(self, start: Point, end: Point, rx: float, ry: float,
        ...
        This wraps the proven a2c logic from core/paths/a2c.py.
...
class DrawingMLAdapter:
    ...
    Wraps core/paths/drawingml_generator.py functionality.
    """
...
class CompatPathAdapter:
    """
    Main adapter for the proven path conversion functionality.
