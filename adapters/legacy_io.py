...
class PPTXBuilderAdapter:
    ...
    Wraps src/pptx/package_builder.py and related PPTX generation logic
    ...
    def _path_to_shape_xml(self, path: IRPath, element_id: int) -> str:
        ...
        # This would delegate to the legacy path adapter
...
class LegacyIOAdapter:
    """
    Main adapter for legacy I/O functionality.
