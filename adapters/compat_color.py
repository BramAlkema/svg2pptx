...
class ColorSystemAdapter:
    ...
    Wraps core/color/ functionality to provide color parsing, conversion,
    ...
    def parse_color_to_solid_paint(self, color_str: str, opacity: float = 1.0) -> Optional[SolidPaint]:
        ...
        Wraps the proven color parsing logic from core/color/core.py.
    ...
    def harmonize_colors(self, base_color: str, scheme: str = "complementary") -> List[str]:
        ...
        Wraps core/color/harmony.py functionality.
    ...
    def check_accessibility(self, foreground: str, background: str) -> Dict[str, Any]:
        ...
        Wraps core/color/accessibility.py functionality.
    ...
    def manipulate_color(self, color: str, operation: str, amount: float = 0.1) -> str:
        ...
        Wraps core/color/manipulation.py functionality.
...
class CompatColorAdapter:
    """
    Main adapter for compatibility color system functionality.
