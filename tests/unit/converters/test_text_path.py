...
class TestTextPathInfo:
    ...
    def test_text_path_info_creation(self):
        ...
        color_info = ColorInfo(red=255, green=0, blue=0, alpha=1.0, format=ColorFormat.RGB, original="rgb(255,0,0)")
...
class TestFontMetrics:
    ...
    def test_get_character_advance_narrow_chars(self):
        ...
        for char in 'il1|!':
            ...
            # Narrow characters should have some advance width
            assert advance > 0
            assert isinstance(advance, (int, float))
    ...
    def test_get_character_advance_wide_chars(self):
        ...
        for char in 'MW':
            advance = metrics.get_character_advance(char)
            # Wide characters should have some advance width
            assert advance > 0
            assert isinstance(advance, (int, float))
...
class TestTextPathConverter:
    ...
    def setup_method(self):
        ...
        self.converter.color_parser.parse.return_value = ColorInfo(255, 0, 0, 1.0, format=ColorFormat.RGB, original="rgb(255,0,0)")
